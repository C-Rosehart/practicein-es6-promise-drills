...
//than or greater than the value 10.
...
const testNum = (testingActive) => new Promise((resolve, reject) => {
  if(testingActive > 10) {
    resolve(testingActive + ' is greater than 10, success!');
  } else {
    reject(testingActive + ' is lesss than 10, error!');
  }
});
...
//the promise should test if the value (object?) is less than or greater than the value of 10
...
//sortWords(), will sort the words in alphabetical order. If the array contains anything 
